...
public class DBconnector1 extends MonoBehaviour{
	...
	*/
	public function Track (myTracks: JSONObject[]){
		...
		if(PlayerPrefs.HasKey("sessionKey")){
			...
			//Connections.Add(new Connection(url, myTracks));		//This will create a new Connection object, which will post the track on the database. This connection object will be added to a queue.
...
public class Connection1{// extends System.Object{
	...
	private class ConnectionQueue1{
		/*
